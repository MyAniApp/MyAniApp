    ...
    return Pagination(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          var character = widget.characters.edges![index]!;
          var voice = character.voiceActorRoles!.firstWhere(
            (element) => element?.voiceActor?.languageV2 == selectedLanguage,
            orElse: () => null,
          );
          ...
          return Material(
            ...
            child: InkWell(
              onTap: () =>
                  context.pushRoute(CharacterRoute(id: character.node!.id)),
              child: Stack(
                children: [
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      SizedBox(
                        ...
                        child: AspectRatio(
                          ...
                          child: ClipRRect(
                            ...
                            child:
                                CImage(imageUrl: character.node!.image!.large!),
                          ),
                        ),
                      ),
                      Padding(
                  ...
                  if (voice != null)
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () => context
                            .pushRoute(StaffRoute(id: voice.voiceActor!.id)),
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.end,
                          children: [
                            Padding(
