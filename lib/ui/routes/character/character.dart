                          ...
                          Expanded(
                            child: ListView(
                              ...
                              children: [
                                ...
                                if (result.parsedData!.Character!.dateOfBirth !=
                                        null &&
                                  ...
                                  Text.rich(
                                    TextSpan(
                                      children: [
                                        ...
                                        TextSpan(
                                          text:
                                              result.parsedData!.Character!.age,
                                        )
                                      ],
                                    ),
                                  ),
                ...
                slivers: [
                  ...
                  SliverToBoxAdapter(
                    child: GridCards(
                      ...
                      card: (index) {
                        var media =
                            result.parsedData!.Character!.media!.edges![index]!;
                        ...
                        return GridCard(
                          ...
                          index: index,
                          onTap: (index) =>
                              context.pushRoute(MediaRoute(id: media.node!.id)),
                        );
                      },
                      itemCount:
